        ...
        with tabs[6]:
            ...
            if not u_df.empty:
                ...
                if not approved_users.empty:
                    ...
                    # 삭제할 회원 선택 (admin 계정은 본인이므로 목록에서 제외 권장)
                    ...
                    if manage_list:
                        ...
                        if st.button("🔥 회원 계정 영구 삭제", help="주의: 해당 회원은 즉시 시스템에서 제거됩니다."):
